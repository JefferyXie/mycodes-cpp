...
//
// In contrast, Floyd Warshall algorith is using to calc shortest path between
...
// this is actually not Dijkstra algorith, check the geeksforgeeks link
// above and see the details
vector<int>
graph_dijkstra(int n, vector<vector<int>> edges, int s)
{
