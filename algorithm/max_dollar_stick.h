#ifndef MAX_DOLLAR_STICK_H
#define MAX_DOLLAR_STICK_H
...
{
    int prices_1[] = {1, 3};
    cout << max_dollar_stick(prices_1, sizeof(prices_1)/sizeof(prices_1[0])) << endl;
    int prices_2[] = {1, 3, 4};
    cout << max_dollar_stick(prices_2, sizeof(prices_2)/sizeof(prices_2[0])) << endl;
    int prices_3[] = {1, 4, 5, 7};
    cout << max_dollar_stick(prices_3, sizeof(prices_3)/sizeof(prices_3[0])) << endl;
    int prices_4[] = {2, 3, 4, 8, 9};
    cout << max_dollar_stick(prices_4, sizeof(prices_4)/sizeof(prices_4[0])) << endl;
}
