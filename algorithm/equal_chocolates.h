#ifndef EQUAL_CHOCOLATES_H
#define EQUAL_CHOCOLATES_H
...
int equal_chocolates_1(vector<int> a)
{
    sort(a.begin(), a.end());
...
*/
int equal_chocolates_2(vector<int> cookies)
{
