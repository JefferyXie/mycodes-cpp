...
//
pair<int,int>
rotate_left(int X, int Y, int row_s, int col_s, int row_e, int col_e, int steps) {
...
pair<int,int>
rotate_bottom(int X, int Y, int row_s, int col_s, int row_e, int col_e, int steps) {
    int edge_h = col_e - col_s;
    int edge_v = row_e - row_s;
    int perm = 2*(edge_h+edge_v);
    steps %= perm;
...
pair<int,int>
rotate_right(int X, int Y, int row_s, int col_s, int row_e, int col_e, int steps) {
    int edge_h = col_e - col_s;
    int edge_v = row_e - row_s;
    int perm = 2*(edge_h+edge_v);
    steps %= perm;
...
pair<int,int>
rotate_top(int X, int Y, int row_s, int col_s, int row_e, int col_e, int steps) {
    int edge_h = col_e - col_s;
    int edge_v = row_e - row_s;
    int perm = 2*(edge_h+edge_v);
    steps %= perm;
...
vector<vector<int> > matrix_rotation(const vector<vector<int> >& matrix, int R)
{
