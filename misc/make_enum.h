...
void run_make_enum()
{
    ...
    cout << "to_string(dog):" << get_enum_name(dog) << endl;
//    cout << "to_string(11):" << to_string((Animal)11) << endl;
//    cout << "to_string(__COUNT):" << to_string(Animal::__COUNT) << endl;
  
    cout << "to_string(ST_F_XS):" << get_enum_name(STRATEGY_TYPE::ST_F_XS) << endl;
    cout << "to_string(ST_F_MIN):" << get_enum_name(STRATEGY_TYPE::ST_F_MIN) << endl;
    cout << "to_string(ST_O_12):" << get_enum_name(STRATEGY_TYPE::ST_O_12) << endl;
    cout << "to_string(ST_O_13):" << get_enum_name(STRATEGY_TYPE::ST_O_13) << endl;
