...
size_t curl_response_callback(void* contents, size_t size, size_t nmemb, void* user_data)
{
...
void curl_http_post(const std::string& url, const std::string& header, const std::string& data)
{
    CURL*    curl;
    CURLcode res;
...
void run_curl()
{
    ...
    std::string idsecret =
        "b7b9974e8e2244e387ab64cadd0d667a:830b5b391b474a4780a8697d0396a27762aa40367e8549578ae71149df8c78c5";
