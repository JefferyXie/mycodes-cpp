#ifndef TEMPLATE_GENERIC_FACTORY_H
#define TEMPLATE_GENERIC_FACTORY_H
...
struct generic_factory_t
{
    ...
    {
        static generic_factory_t inst; return inst;
    }
    ...
    void* create(const std::string& name)
    {
        ...
        std::cout << "generic_factory_t::create: cannot find "
                  << name << std::endl;
        return nullptr;
    }
};
...
template<class CLASS, class FACTORY>
typename generic_register_t<CLASS, FACTORY>::registor_t
 generic_register_t<CLASS, FACTORY>::registor_;
// 
...
struct register_A : public generic_register_t<register_A, generic_factory_t> {
    ...
    register_A() {
        std::cout << "register_A() is called." << std::endl;
    }
};
...
struct register_B : public generic_register_t<register_B, generic_factory_t> {
    ...
    register_B() {
        std::cout << "register_B() is called." << std::endl;
    }
};
